...
# pip install fastapi uvicorn python-multipart opencv-python tensorflow==2.8.0  keras
# pip install fastapi uvicorn python-multipart opencv-python tensorflow keras
...
# model.save_model("cat_and_dogs.h5")
model = tf.keras.models.load_model("cat_and_dogs.h5")
print(model.summary())
# 25분진행
upload_dir = "E:/최남회/250905_main_어제연습한내용_/upload"
    ...
    try:
        ...
        if(logic1 | logic2):
            ...
            for file in files:
                ...
                print(img_resize[np.newaxis].shape) 
                pred = model.predict(img_resize[np.newaxis])
                print("prob",pred)
